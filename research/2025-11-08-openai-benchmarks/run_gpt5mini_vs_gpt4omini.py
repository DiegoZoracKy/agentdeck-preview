"""
GPT-5-mini vs GPT-4o-mini Comparison Experiment

Research Question: Does GPT-5-mini's improved reasoning outperform GPT-4o-mini
...
- Seed: 2024
- Concurrency: 10
- Temperature: 1.0 (GPT-5-mini only supports this value)
- Game: FixedDamageGame (partial info, 2 potions)
- Controller: ReasoningController

Result (2025-11-19): 50/50 tie - no performance difference, GPT-5-mini costs 5.2x more

Usage:
    python docs/research/2025-11-08-openai-benchmarks/run_gpt5mini_vs_gpt4omini.py
"""
...
from agentdeck.spectators import MatchNarrator, ProgressDisplay, StatsTracker, TokenUsageTracker
from agentdeck.core.types import LogLevel


# Experiment parameters
MATCHES = 30  # Reasonable sample for statistical significance
SEED = 2024
CONCURRENCY = 10
...
def build_players() -> tuple:
    """Create GPT-5-mini and GPT-4o-mini players with ReasoningController."""
    ...
    gpt4o_mini = GPTPlayer(
        name="GPT-4o-mini",
        model="gpt-4o-mini",
        temperature=1.0,  # Match GPT-5-mini for fair comparison
        controller=ReasoningController(),
    )

    return gpt5_mini, gpt4o_mini
