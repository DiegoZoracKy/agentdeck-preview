...
- [`deck_qa_checklist.md`](deck_qa_checklist.md) - review gate for generated decks, videos, or scripts.
- [`technical_report_outline.md`](technical_report_outline.md) - recommended technical case-study structure.
- [`prior_research_context.md`](prior_research_context.md) - how to use older arc packages as background.
