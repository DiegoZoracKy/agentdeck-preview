"""
Gemini 2.5 Flash vs GPT-4o-mini Comparison Experiment

Research Question: How does Gemini 2.5 Flash compare to GPT-4o-mini in strategic gameplay
...
Usage:
    python docs/research/2025-11-19-multi-provider-benchmarks/run_gemini25flash_vs_gpt4omini.py
"""
...
def build_players() -> tuple:
    """Create Gemini 2.5 Flash and GPT-4o-mini players using ReasoningController."""
